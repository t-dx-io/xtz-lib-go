...
func Logging(logger *logger.ContextLogger) func(service.XTZer) service.XTZer {
...
func (mw *logging) AddAddresses(ctx context.Context, req *service.AddAddressesReq) error {
	now := time.Now()
...
func (mw *logging) Broadcast(ctx context.Context, req *service.BroadcastReq) (string, error) {
	now := time.Now()
...
func (mw *logging) GetBlockchainInfo(ctx context.Context, req *service.GetBlockchainInfoReq) (*model.BlockchainInfo, error) {
	now := time.Now()
...
func (mw *logging) GetEstimatedFee(ctx context.Context, req *service.GetEstimatedFeeReq) (*model.Fees, error) {
	now := time.Now()
...
func (mw *logging) GetBalances(ctx context.Context, req *service.GetBalancesReq) ([]*model.Balance, error) {
	now := time.Now()
...
func (mw *logging) GetCounters(ctx context.Context, req *service.GetCountersReq) ([]*model.Counter, error) {
	now := time.Now()
...
func (mw *logging) GetTransactionsByHashes(ctx context.Context, req *service.GetTransactionsByHashesReq) ([]*model.Transaction, uint64, error) {
	now := time.Now()
...
func (mw *logging) GetTransactionsByBlocks(ctx context.Context, req *service.GetTransactionsByBlocksReq) ([]*model.Transaction, uint64, uint64, error) {
	now := time.Now()
...
func (mw *logging) GetTransactionsByDates(ctx context.Context, req *service.GetTransactionsByDatesReq) ([]*model.Transaction, uint64, uint64, error) {
	now := time.Now()
...
func (mw *logging) GetRawTransactionHash(ctx context.Context, rawTransaction string) (string, error) {
